...
project1 = Project.create!(name: "Basquiat", description: "Jean-Michel Basquiat", body: "Jean-Michel Basquiat; December 22, 1960 – August 12, 1988
    ...
    internationally. The Whitney Museum of American Art held a retrospective of his art in 1992.", funding_expiration: DateTime.new(2020, 1, 1), funding_goal: 1000000,
...
project2 = Project.create!(name: "Catman", description: "Harold the Catman", body: "Catman (Harold) is a fictional character in comic books published by DC 
    ...
    funding_expiration: DateTime.new(2020, 6, 22), funding_goal: 95000, user_id: user2.id, category_id: category2.id)
